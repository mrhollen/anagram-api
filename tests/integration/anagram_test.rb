...
class TestCases < Test::Unit::TestCase
  ...
  def test_deleting_all_anagrams_of_word
  ...
  def test_is_anagram_list_returns_true

    # call check endpoint
    res = @client.post('/check.json', nil, {"words" => ["read", "dear", "dare"] })
  ...
  def test_is_anagram_list_returns_false

    # call check endpoint
    res = @client.post('/check.json', nil, {"words" => ["reed", "dear", "dare"] })
